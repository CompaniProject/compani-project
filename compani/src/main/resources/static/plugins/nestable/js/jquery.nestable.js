!function(t,e,s,i){
    ...
    o=function(){
        ...
        i=s.documentElement;if(!("pointerEvents"in t.style))
        return!1;
        ...
        group:0,maxDepth:5,threshold:20};function n(e,i){
            ...
            n.prototype={
                init:function(){
                    ...
                    t.each(this.el.find(s.options.itemNodeName),
                    function(e,i){s.setParent(t(i))}),
                    s.el.on("click","button",function(e){
                        if(!s.dragEl){
                            ...
                            var i=function(e){var i=t(e.target);
                                ...
                                o=function(t){
                                    ...
                                    l=function(t){
                                        s.dragEl&&(t.preventDefault(),
                                        s.dragStop(t.touches?t.touches[0]:t))
                                    };
                                    a&&(s.el[0].addEventListener("touchstart",i,!1),
                                    e.addEventListener("touchmove",o,!1),
                                    e.addEventListener("touchend",l,!1),
                                    e.addEventListener("touchcancel",l,!1)),
                                    s.el.on("mousedown",i),s.w.on("mousemove",o),
                                    s.w.on("mouseup",l)},
                                    serialize:function(){
                                        var e=this;return step=function(s,i){
                                            var a=[];
                                            return s.children(e.options.itemNodeName).each(function(){
                                                var s=t(this),o=t.extend({},s.data()),l=s.children(e.options.listNodeName);
