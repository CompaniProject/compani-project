...
public interface BusinessMemberService {
	...
	/*
	 * // 이것은 개인피드백에서 총 업무갯수를 찾는 SQL문 입니다. public int
	 * getMemberBusinessCnt(BusinessMemberVO vo); public Map<String, Integer>
	 * getMemberBusinessStateCnt(List<Map<String, String>> list);
	 */
